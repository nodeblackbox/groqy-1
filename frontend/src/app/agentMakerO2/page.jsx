...
const SUPPORTED_MODELS = [
    ...
    { id: "llama3-groq-70b-8192-tool-use-preview", name: "Llama 3 Groq 70B Tool Use (Preview)", contextWindow: 8192 },
    { id: "llama3-groq-8b-8192-tool-use-preview", name: "Llama 3 Groq 8B Tool Use (Preview)", contextWindow: 8192 },
...
export default function EnhancedACEWorkflowBuilder() {
    ...
    const [contextLength, setContextLength] = useState(SUPPORTED_MODELS[0].contextWindow);
    ...
    const handleChatSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    messages: [
                        { role: "system", content: "You are an AI assistant helping to create an initial prompt for an ACE Workflow. Provide concise and relevant responses. Use markdown formatting for rich text output, including code blocks where appropriate." },
