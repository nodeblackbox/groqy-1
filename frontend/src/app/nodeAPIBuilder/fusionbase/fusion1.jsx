...
import { PlusCircle, Trash2, Save, Upload, Settings, Play, ChevronDown, ChevronRight, Edit, Copy } from 'lucide-react';
    ...
    return (
        <div className="h-screen flex flex-col bg-gray-900 text-white">
            ...
            <div className="p-4 border-b border-cyan-700 flex justify-between items-center">
                <h1 className="text-2xl font-bold text-cyan-400">Node API Builder</h1>
                <div className="flex space-x-2">
                        ...
                        <DialogContent className="bg-gray-800 text-cyan-400 border-cyan-500">
                            ...
                            <Button
                                onClick={() => {
                                    ...
                                    setNodes((nds) => nds.concat(newNode));
                                    setIsAddingTask(false);
                                    toast.success("Your new quantum task has been added to the workflow.");
                                }}
                    ...
                    <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
                        ...
                        <DialogContent className="bg-gray-800 text-cyan-400 border-cyan-500">
                            <DialogHeader>
                                <DialogTitle className="text-cyan-400">Node API Builder Settings</DialogTitle>
                            </DialogHeader>
                            <div className="space-y-4">
                                <div>
