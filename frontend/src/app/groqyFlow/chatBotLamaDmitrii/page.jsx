              ...
              messages: [
                {
                  role: "system",
                  content:
                    "You are a very intellectual programmer and you are very good at programming. You're just going to answer in a programming way.",
                },
                userMessage,
              ],
              stream: false,
          ...
          "http://localhost:3000/api/openai/v1/chat/completions",
          {
            ...
            body: JSON.stringify({
              ...
              messages: [
                {
                  role: "user",
                  content: "You are a an English teacher.",
                },
                userMessage,
              ],
              temperature: 1,
