...
const generateTasksFromPrompt = async (prompt, knowledgeBase) => {
    try {
        ...
        const generatedTasks = [
            {
                ...
                type: "Process",
                config: { process: "Process based on prompt" },
                subtasks: [],
                connections: [],
            },
            {
...
export default function EnhancedWorkflowBuilder() {
    ...
    const generateTasks = useCallback(
        ...
        [state.knowledgeBase, generateMermaidCode]
    );
