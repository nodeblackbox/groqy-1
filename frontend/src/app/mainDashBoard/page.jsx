...
import KanbanBoardView from '@/components/mainDashboardComponents/views/KanbanBoardView';
...
//                     {['Implement user authentication', 'Design new landing page', 'Optimize database queries', 'Write unit tests'].map(
//                         (task, index) => (
...
//                 <ul className="space-y-2">
//                     {['Code Review Assistant', 'Bug Prediction Model', 'Automated Testing Pipeline', 'Performance Optimization Analyzer'].map(
//                         (workflow, index) => (
                    ...
                    <nav className="hidden md:flex flex-col w-64 bg-gray-800 bg-opacity-50 p-4 space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-purple-600 scrollbar-track-gray-700">
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                ...
                                className={`p-1 rounded-full transition-colors duration-200 ease-in-out ${isAIMode ? 'bg-purple-600' : 'bg-gray-600'
                                    }`}
                            >
                                {isAIMode ? (
