...
class AgentFactory {
    ...
    async createAgentsFromPrompt(prompt, model, contextLength, ethics, morality) {
        try {
...
Create agents that align with this information and the user's prompt. Ensure each agent has a unique name and fully populated layers.`;
