...
function GoopField() {
  ...
  const {
    ...
    noiseScale: { value: 3, min: 0.1, max: 200, step: 0.1 },
    noiseSpeed: { value: 0.2, min: 0.01, max: 2, step: 0.01 },
    bumpStrength: { value: 0.2, min: 0, max: 3, step: 0.01 },
    colorIntensity: { value: 1.5, min: 0.5, max: 3, step: 0.1 },
    specularStrength: { value: 1.0, min: 0, max: 3, step: 0.01 },
    shininess: { value: 32.0, min: 1, max: 128, step: 1 },
